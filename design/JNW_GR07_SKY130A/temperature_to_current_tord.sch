...
S {}
E {}
T {I_R1=(V_D1-V_D2)/R1=(V_T*ln(N))/R1} 160 180 0 0 0.4 0.4 {}
...
N 260 160 260 260 {lab=#net4}
N 260 80 260 100 {lab=V_REF}
...
C {devices/res.sym} 260 130 0 0 {name=R2
value=11k
footprint=1206
device=resistor
m=1}
