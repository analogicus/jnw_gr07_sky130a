...
S {}
E {}
B 2 -410 -670 390 -270 {flags=graph
y1=0u
...
C {devices/simulator_commands_shown.sym} 470 -570 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
...
.end
"}
C {devices/launcher.sym} -340 -710 0 0 {name=h5
descr="load waves (press ctrl + left click)" 
tclcommand="xschem raw_read $netlist_dir/temp_to_current_tb.raw tran"
}
